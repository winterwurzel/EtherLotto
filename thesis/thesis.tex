...
\ifthenelse{\equal{\yourLanguage}{german}}{
  ...
  \include{chapters/20_general}   
  \include{chapters/30_relatedwork}   
  \include{chapters/40_concept}    
  \include{chapters/50_implementation}   
  \include{chapters/60_setup}   
  \include{chapters/70_pseudorandom}   
  \include{chapters/75_comparison}   
  \include{chapters/80_security}   
